...
See [`examples/`](examples/) for three sample notes generated by the tool on real YouTube videos. They give you a concrete idea of what the output looks like without having to run the pipeline yourself.
